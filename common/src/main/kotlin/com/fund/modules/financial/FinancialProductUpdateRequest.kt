 ...
 * 理财产品更新请求
 */
@Schema(description = "理财产品更新请求")
data class FinancialProductUpdateRequest(
    @Schema(description = "产品ID", required = true, example = "1")
    val id: Long,
    
    @Schema(description = "产品标题", example = "稳健理财产品-升级版")
