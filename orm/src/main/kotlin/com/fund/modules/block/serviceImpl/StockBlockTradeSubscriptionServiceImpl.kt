    ...
    override fun update(req: BlockTradeUpdateRequest, userId: Long): R<Any> {
        try {
            ...
            return RedisLockService.lockTransaction(key) block@{
                ...
                // 查询申购记录
                val subscription = this.getOne(KtQueryWrapper(StockBlockTradeSubscription())
                    .eq(StockBlockTradeSubscription::userId, userId)
                ...
                // 获取大宗交易信息
                val blockTrade = stockBlockTradeService.getById(subscription.blockTradeId) ?: throw BusinessException("block_trade_null")
